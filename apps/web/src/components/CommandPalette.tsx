...
export const CommandPalette: React.FC<CommandPaletteProps> = ({ isOpen, onClose, onNavigate, onAction }) => {
  ...
  const commands = useMemo<CommandItem[]>(() => {
    const items: CommandItem[] = [
      ...
      { id: 'nav-investments', label: 'Investments', group: 'Pages', icon: <TrendingUp size={16} />, action: () => onNavigate('investments'), keywords: 'stocks mutual funds fd gold nps US stocks crypto bonds' },
