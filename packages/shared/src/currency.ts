...
/**
 * Compact INR formatting with no fraction digits — used for tax figures,
 * readouts, and export text where paise carry no meaning.
 */
export const formatRupeeCompact = (value: number | undefined | null): string => {
  if (value === undefined || value === null || isNaN(value)) {
    value = 0;
  }
  return new Intl.NumberFormat('en-IN', {
